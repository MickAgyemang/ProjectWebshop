...
button {
    display: block;
    width: 100px; /* Aangepast om de knoppen even groot te maken */
    padding: 10px;
    ...
    cursor: pointer;
    font-size: 16px;
    margin-top: 10px; /* Toegevoegd om wat ruimte tussen de knoppen en de inhoud van de review te creëren */
}
